...
"I was picturing 'how to turn a sphere inside out', but yes, I played <cite>Eversion</cite>. Deep cut."
...
"Hey, I've got it." Violet zoomed on an image on her phone, a passage from a novel. I read: <i>I don't know what it is about computers and gender people, maybe something to do with changing realities.</i> I looked down a bit. <i>Annie-O and her people considered what they did to be a sacred obligation, opening tunnels between the virtual world and the physical.</i> On another line, Annie suggested the narrator's inability to find her way in virtual worlds was the hallmark of a fixed gender.
...
The Mari Lwyd NPC is inspired by a [Welsh wassailing tradition](https://en.wikipedia.org/wiki/Mari_Lwyd).
