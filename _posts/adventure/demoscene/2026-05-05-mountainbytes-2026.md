...
Let's quickly run down those credits! In the director's chair was fellow Scottish scener [Mrs Beanbag](https://demozoo.org/sceners/66552/), and her partner [Aldroid](https://demozoo.org/sceners/63755/) is credited as the 'associate producer'. [Halcy](https://demozoo.org/sceners/3845/) is further credited as 'assistant director'. My friends [Vurpo](https://demozoo.org/sceners/138609/) and [RaccoonViolet](https://demozoo.org/sceners/90373/) worked together on the character designs and 3D models, with [Ando](https://demozoo.org/sceners/90946/) credited for 2D graphics (at a guess, perhaps the faces of the characters?). [Jeenio](https://demozoo.org/sceners/3048/) coordinated musicians [jco](https://demozoo.org/sceners/1981/) and [Gasman](https://demozoo.org/sceners/5879/) to cover the multiple tracks in the demo, and [Enfys](https://demozoo.org/sceners/89891/) covered further sound effects while [Bus Error](https://demozoo.org/sceners/80132/) and [Ziphoid](https://demozoo.org/sceners/852/) voiced the characters. I'm told most of the code was written by Halcy, Aldroid and Mrs Beanbag; Gasman is also credited for 'additional code'. The full repo is available on [Codeberg](https://codeberg.org/aldroid/revision-2026-invite), with the commit history squashed.
