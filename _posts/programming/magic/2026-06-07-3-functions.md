...
```
Here we have declared an unsigned 32-bit integer, a signed 64-bit integer, a 32-bit float, an array of integers, a string slice, and a complicated thing that I'm mostly including as foreshadowing ;p
