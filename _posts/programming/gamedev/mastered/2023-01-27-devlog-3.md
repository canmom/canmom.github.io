...
```
which connects the job up to the automatic dependency management without forcing the main thread to wait. As soon as I did this, I got about a 20fps increase!
