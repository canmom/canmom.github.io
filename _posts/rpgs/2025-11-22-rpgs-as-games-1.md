---
title: "what sort of game is an RPG? part 1: Suits and friends"
layout: article
categories:
 - rpgs
excerpt: Cracking open my books of philosophy and game design theory in the hope of figuring out how they square with that strange species of game, the RPG.
tags:
 - rpgs
 - rpg design
---
...
> A game is a <i>system</i> in which <i>players</i> engage in an <i>artificial</i> <i>conflict</i>, defined by <i>rules</i>, that results in a <i>quantifiable outcome</i>.

followed by elaborations of each of the defined words which are all more or less what you'd expect. The *artificial* one is particularly significant, though: Salen and Zimmerman elaborate on Huizinga's concept of the 'magic circle', describing the (constantly ongoing) process by which people delineate the self-contained 'game' from the wider world. (Besides Huizinga, they draw here on the work of Stephen Sniderman, who wrote a great article on [unwritten rules](https://www.gamepuzzles.com/tlog/tlog2.htm) which we'll be coming back to later.)
...
Bernard Suits, in <cite>The Grasshopper</cite> (1978), was motivated by an attempt to overcome Wittgenstein's philosophical challenge and provide a robust definition of games, presented in a very prettily illustrated book of playful Socratic dialogues between the Grasshopper of Aesop's fable and his disciple 'Skepticus'.
...
At the time Suits was writing, roleplaying games had only just been invented, so inevitably they are not on his radar---but he does spend a good four chapters of <cite>The Grasshopper</cite> discussing whether childrens' games such as 'house' or 'cops and robbers' fit his definition of roleplaying.
...
Perhaps we RPG nerds have gone ahead and done exactly what Suits had in mind! He's still around, actually---I'm not sure if he got around to considering modern RPGs in his later sequel, <cite>Return of the Grasshopper</cite>...
...
This long history of argument [is the focus of another review Arthur B](https://refereeingandreflection.wordpress.com/2021/09/18/the-shifting-definitions-of-roleplaying/), a long-time online reviewer of all sorts of nerd shit, someone who by odd coincidence I used to be online friends with on a website called FerretBrain.

<aside>(hey Arthur if you read this, hope you're doing good! I posted as 'Bryn' back then.)</aside>

In his article, Arthur goes over some of these cyclical debates, and argues that for all they proved cyclic, they proved worthwhile because the tensions within all these different theories proved generative of new, influential game designs---from Peterson's examples of <cite>Champions</cite> and <cite>Call of Cthulhu</cite> in 1981 to the Forge-diaspora in the 2010s that gave us PbtA and all of its consequences.
...
For now, I'll save further summary and long quotes. Over the rest of this series, I'll be pulling from <cite>The Elusive Shift</cite> frequently, because it turns out all the questions we'll address came up in the 70s too...
