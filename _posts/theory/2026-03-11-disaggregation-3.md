...
- {: .person1} As Uminekoheads in the chat know, the <cite>[Key of Solomon](https://sacred-texts.com/grim/kos/)</cite> is one of a number of grimoires circulating in the European 'Renaissance', and it is followed a century or two later by another <cite>[Lesser Key of Solomon](https://sacred-texts.com/grim/lks/)</cite>. They describe rituals, demons whose powers can supposedly be called upon, and sigils to command them, all ordered into a great big list.
...
- {: .person3} The line between the strange-person hole and the overwhelming mass is pretty nebulous, isn't it. Consider aoife's words on the default persona. Consider that [the writer of Lain](https://en.wikipedia.org/wiki/Chiaki_J._Konaka) went on to become a right-wing conspiracy theorist.
