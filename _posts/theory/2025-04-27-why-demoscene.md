...
> <b>note from the (near) future:</b> This article prompted some discussion on Discord, and Wrighter showed me quite a few demos which fit the pattern I described in Line Rider: personal projects on emotive subjects. Notably, there is a difference between *votes at parties* and *praise on Pouet*. It is not entirely fair to say that the interests of the demoscene are so exclusively technical: the scene is large enough to encompass a variety of styles, and the line between 'art' and 'technical' continues to be something actively debated. I'll leave the rest of the article unedited, to revisit in more depth in the future!
