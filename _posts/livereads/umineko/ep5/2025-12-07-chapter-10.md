...
{% include figure.html src="embed/umineko/ep5/48-anti-tamper.webp" alt="A picture of the duct tape seal. Narration: ......It was written in a very elaborate and decorative manner, and if it was a signature, Kanon had no idea whose name was written." capt="Looks like 'E. Furudo' on the first line, and maybe something like 'Franchesca Bernkastel' on the second? Is that Bernie's first name?" %}
...
{% include figure.html src="embed/umineko/ep5/49-manners.webp" alt="Erika: .........Alright, has everyone gotten the weeping out of their system? Let's have some order, please. ......Has anyone seen Krauss‐san yet?" %}
...
{% include figure.html src="embed/umineko/ep5/50-elementary.webp" alt="Erika: ...All it takes is the presence of that magic circle, and a deduction like this becomes trivial for Furudo Erika. ...Your thoughts, ladies and gentlemen?" %}
...
{% include figure.html src="embed/umineko/ep5/51-meta.webp" alt="Beatrice: Still, that Lady Lambdadelta and Lady Bernkastel... They've finally started doing whatever they like with my game board...!" %}
...
{% include figure.html src="embed/umineko/ep5/52-krauss-room.webp" alt="Eva standing in Krauss's room." capt="I found the version in the game files, but it has transparent windows, so instead have this screenshot with Eva standing in it." %}
