...
> 
> <b class="name smallcaps">Beatrice:</b> <span class="red">In short, all keys related to the linked locked rooms were locked {i:inside</span> the linked locked rooms}!! <span class="red">No key could have been returned from outside the room using a crack in a door, a crack in a window, a vent or any place of the sort</span>!!
> 
